...
parser.add_argument("-nn", "--nn_model", help="select model path for inference", default='models/fastscnn_720x1280.blob', type=str)
...
def decode_deeplabv3p(output_tensor):
    output = output_tensor.reshape(nn_shape2, nn_shape1)
...
if cam_source == 'rgb':
    ...
    cam.setPreviewSize(nn_shape1,nn_shape2)
...
if cam_source != 'rgb':
    ...
    manip.setResize(nn_shape1,nn_shape2)
...
with dai.Device() as device:
    ...
    while True:
        ...
        # get layer1 data
        lay1 = np.array(in_nn.getFirstLayerInt32()).reshape(nn_shape1,nn_shape2)
